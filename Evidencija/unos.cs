        ...
        private void btnSpremi_Click(object sender, EventArgs e)
        {
            using (var db = new evidencijaEntities())
            {
                ...
                {                    
                    ...
                    {
                        if (item.danUMjesec.Contains(dtpDatum.Value.ToString("dd")) && item.djelatnik.id == odabraniDjelatnik.id)
                        {
                            DialogResult dialogResult = MessageBox.Show("Već postoji unos za taj dan. Novi unos" +
                                " će zamijeniti stari. Želite li nastaviti?",
        ...
        private void Dodaj(djelatnik odabraniDjelatnik, vrstaRada odabranaVrsta)
        {
            if (txtBrojSati.Text != "")
            {
                ...
                using (var db = new evidencijaEntities())
                {
                    ...
                    DR.danUTjednu = (int)dtpDatum.Value.DayOfWeek;
